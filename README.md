...
## Requirements
This project requires the TISEAN package to be installed and on your system's PATH. TISEAN can by found under (https://www.mpipks-dresden.mpg.de/tisean/
Tisean_3.0.1/index.html).
